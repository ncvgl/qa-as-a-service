...
export const labIdSchema = z.enum(["kanban", "paint", "booking", "custom"]);
export type LabId = z.infer<typeof labIdSchema>;

export const categorySchema = z.enum(["productivity", "creativity", "commerce", "custom"]);
...
export const runRecordSchema = z.object({
  ...
  statelessMode: z.boolean().optional(),
