...
export function OperatorConsole({
  ...
  const selectedScenarioTitle = selectedScenario?.title ?? (isCustom ? "Custom Task" : "Selected app");
  const stageUrl =
  ...
  const stopDisabled =
    ...
    pendingAction !== null;
  const resetDisabled =
    !runnerOnline || isCustom || !selectedScenario || pendingAction === "start";
        ...
        <section className="benchTop">
          <section className="controlColumn">
            <RunControls
              ...
              onStatelessModeChange={setStatelessMode}
