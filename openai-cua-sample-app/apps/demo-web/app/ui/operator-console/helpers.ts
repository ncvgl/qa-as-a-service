...
export const statelessHelpText =
  "Each turn sends only the current screenshot and a text summary of prior actions instead of the full conversation history. Uses fewer tokens but the model loses visual memory of earlier turns.";
