...
MODEL    = "Qwen/Qwen3-4B"
PROMPTS  = ["Why did Rome fall?", "Why do LLMs hallucinate?"]  #
N_MAIN   = 200
H_FLOOR  = 1.5
MAX_CAND_POS = 8
K        = 4
...
N_CONT   = 55
N_SPIKES = 3
CHUNK    = 10          # max sequences per batched forward
...
json.dump(results, open("/tmp/exp_refine_4b.json", "w"), indent=2)
print("WROTE /tmp/exp_refine_4b.json")
